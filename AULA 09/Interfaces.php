...
class Hexagono implements Forma {
    public function CalcularArea($lado, $a = 0){ 
        // $a aqui nem precisa, mas deixei pra manter a assinatura igual
...
$hex = new Hexagono();
echo "\nÁrea do Hexágono: ".$hex->CalcularArea(
    readline("\nDigite a medida do lado do hexágono: "),
    0
);